"""Testdaten-/Entwicklermodus — die urspruengliche Single-Page-Ansicht (bis 2026-08-15), jetzt
als eigene Seite im Modul-basierten Guide (siehe docs/backlog.md "Konzept: Modul-basierte,
gefuehrte Analyse"). Bewusst unveraendert erhalten (Nutzer-Vorgabe: bestehende Testdatenbank
bleibt nutzbar, wird nach und nach durch echte Modul-Aufnahmen ersetzt, nicht sofort entfernt).
